...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2017 at 01:52 PM
...
CREATE TABLE `utente` (
  ...
  `Livello` enum('Principiante','Intermedio','Esperto') DEFAULT 'Principiante'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `utente` (`Nickname`, `Email`, `Password`, `Nome`, `Cognome`, `Sesso`, `Data_nascita`, `Luogo_nascita`, `Residenza`, `Livello`) VALUES
('luca', 'luca', 'a05bd890c4868ea1807f8564055d1fba77c6ba81', NULL, NULL, NULL, NULL, NULL, NULL, 'Principiante'),
('mario', 'mario@gmail.com', 'addb47291ee169f330801ce73520b96f2eaf20ea', NULL, NULL, NULL, NULL, NULL, NULL, 'Principiante'),
('paola', 'paola', '825e064b2c85b54b1e40c143e31f24c19bbac07b', NULL, NULL, NULL, NULL, NULL, NULL, 'Principiante'),
('paolo', 'paolo', 'f5973ee9c413d0967b98e0944688acb235fd48bf', NULL, NULL, NULL, NULL, NULL, NULL, 'Principiante'),
('patty', 'patty', '5cfe2396e843538119facabb0902664e73787853', NULL, NULL, NULL, NULL, NULL, NULL, 'Principiante'),
('pino', 'pino', 'beb13b0de46ff9ca6f16e365a66f7adebf894cd6', NULL, NULL, NULL, NULL, NULL, NULL, 'Principiante');
